  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1 class="text-center">
        <strong>DATA USER<br>PT. HEDO GLOBAL TECHNOLOGY</strong><br>
            ...
            <table border="1" class="table table-dark table-hover bg-info text-center">
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <a href="{{ url('admin/cetakdatauser') }}" target="_blank"><i class="fa fa-print"<abbr title="Cetak data"></abbr></i></a>&emsp;
                    <a class="glyphicon glyphicon-trash" style="color: #ff0000e1" onclick="return  confirm('Yakin ingin menghapus data?')" href="/admin/hapususer/{{ $u->id }}"<abbr title="Hapus data"></abbr></a>
                  </td>
                </tr>
              @endforeach
              </tbody>
