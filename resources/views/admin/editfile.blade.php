  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1 class="text-center">
        <strong>EDIT FILE DATA KARYAWAN<br>PT. HEDO GLOBAL TECHNOLOGY</strong><br>
    ...
    <section class="content container">
        <div class="card-body">
            <form action="{{ url('admin/updategambar', $edit->id) }}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="form-group">
                    <label for="">Nama File</label>
                    <input type="text" name="nama" id="nama" class="form-control" required="required" value="{{ $edit->nama }}">
                </div>
                <div class="form-group">
                    <input type="file" name="gambar" id="gambar" class="form-control" required="required">
                </div>
                <div class="form-group">
                    <img src="{{ asset('datafile/'. $edit->gambar) }}" height="10%" width="50%" alt="gambar">
                </div>
