  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1 class="text-center">
        <strong>TAMBAH DATA KARYAWAN<br>PT. HEDO GLOBAL TECHNOLOGY</strong><br>
    ...
    <section class="content container">
        <form action="{{ url('admin/simpandata') }}" method="post">
        @csrf
        <div class="form-row">
          ...
          <div class="m-5">
            ...
            <textarea class="form-control" rows="3" name="alamat" required="required"></textarea>
          </div> <br>
          <div class="m-5">
