  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1 class="text-center">
        <strong>LAPORAN DATA ABSENSI<br>PT. HEDO GLOBAL TECHNOLOGY</strong><br>
    ...
    <section class="content container">
        <div class="table-responsive">
            <table border="1" class="table table-dark table-hover bg-info text-center">
              ...
              <tbody>
                <tr>
                  ...
                  <td>{{ $l->jamkeluar }}</td>
                  <td>{{ $l->jamkerja }}</td>
                  <td><a href="{{ url('admin/cetaklaporanabsensi') }}" target="_blank"><i class="fa fa-print"<abbr title="Cetak data"></abbr></i></a></td>
                </tr>
              @endforeach
              </tbody>
            </table>
          ...
          <br>
          Halaman : {{ $laporanabsen->currentPage() }} <br>
          Jumlah Data : {{ $laporanabsen->total() }} <br>
